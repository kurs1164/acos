        ...
        <div class="row">
            <div class="card w-75 mx-auto mt-3 mb-5 bg-secondary">
                ...
                <p class="text-warning text-center">
                    ...
                    <input type="file" name="edit_pr_image" class=mt-3>
                    <br>
                    <br>
                    EDIT INTRODUCTION <br>
                    <input type="text" name="edit_comment" class="mt-3 form-control">
                
                    <input type="submit" name="edit_pr" value="EDIT PROFILE" class="btn btn-warning mt-4">
                </p>
                </form>
                </div>
