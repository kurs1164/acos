<?php
    ...
    // $user_id = $acosobj->crelogin($_SESSION['crelogin_id']);
    // $_SESSION['creater_name'] = $user_id;
?>
<!doctype html>
<html lang="en">
  <head>
...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavId">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link text-light" href="addProduct.php">SALE</a>
      </li>
...
<div class="container-fuid">
        <div class="jumbotron w-80" style="background-color: rgb(30,43,123)">
            ...
            <p class="text-light lead text-center">
                These are your history as creater !!
            </p>
        </div>
</div>
<div class="container">
      <div class="row">
        <h2 class="display-4">
            Welcome <?php echo $_SESSION['creator_name']?> 
        </h2>
