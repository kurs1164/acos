<?php 
    ...
    $profile = $acosobj->users($_SESSION['login_id']);
    // print_r($profile);
      ...
      <div class="row">
        <div class="card mx-auto w-75 mb-5 mt-3">
            <div class="card-header bg-dark border border-light">
              <p class="float-left">
                <a href="images/<?php echo $profile['image'] ?>" class="pr"><img src="images/<?php echo $profile['image'] ?>" alt="" class="rounded-circle"></a>
              </p>
              <p class="float-right">
                <a href="editProfile.php" class="text-center"><button type=button class="mx-auto btn btn-dark text-info">EDIT PROFILE</button></a>
              </p>
              <p class="mx-auto">
                <h2 class="text-light"><?php echo $profile['username'] ?></h2>
              </p>
            </div>
            <div class="card-body bg-dark">
               ...
               <h3 class="text-info">This User is cheering up those products</h3>
