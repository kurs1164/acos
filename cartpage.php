<?php
  ...
  $cart_products = $acosobj->get_cart_products($_SESSION['login_id']);
  // $_SESSION['sample'] = 'im so handsome';

  // $image = $acosobj->show_products($_SESSION['login_id']);
...
<div class="container-fuid">
        <div class="jumbotron w-80" style="background-color: rgb(0,143,43)">
            <h1 class="text-center text-light">
                YOUR PURCHASE CART
            </h1>
            <p class="text-light lead text-center">
                You haven't finish paying yet !!
            </p>
        </div>
</div>
                ...
                <?php foreach($cart_products as $row){
                  ...
                  ?>
                    <tr>
                        ...
                        <?php // $_SESSION['cart_products'] = $cart_products;  ?>
                        <button type="submit" name="paying" class="btn btn-dark">PURCHASE</button></form></td>
